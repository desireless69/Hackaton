...
function initApp() {
    applyTheme(localStorage.getItem(STORAGE_KEYS.theme) || root.getAttribute("data-theme") || "light");
    applyPreset(localStorage.getItem(STORAGE_KEYS.preset) || root.getAttribute("data-ui-preset") || "mission-control");
    applyDensity(localStorage.getItem(STORAGE_KEYS.density) || root.getAttribute("data-density") || "comfortable");
    wireThemeToggle();
    wirePresetControls();
    wireUploadForm();
}
